        ...
        <div className="flex justify-between gap-3 cursor-pointer">
          <div>
            <div className="flex flex-col gap-6">
              ...
              <TextFooter size className="bottomLigth">
                +998 99 999 99 99
              </TextFooter>
              <TextFooter size className="bottomLigth">
                +998 99 999 99 99
          ...
          <div className="flex flex-col gap-6">
            <TextFooter>Эл.почта:</TextFooter>
            <TextFooter size className="bottomLigth">
              @Tiffest123.@gmail.com
            </TextFooter>
          </div>
          <div className="flex flex-col text-white gap-6 justify-center">
            <TextFooter>Соц. сеть:</TextFooter>
          ...
          <div className="text-white flex flex-col gap-6">
            <TextFooter>Адрес:</TextFooter>
            <div>
              <TextFooter size className="bottomLigth">
                +г. Ташкент ул. Чиланзар 1А,
                <TextFooter size className="bottomLigth">
                  100027
                </TextFooter>
              </TextFooter>
